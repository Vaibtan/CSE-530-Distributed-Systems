...
class Item:
    ...
    def __str__(self):
        return f"ID: {self.id}, Name: {\
            self.name}, Category: {self.category}, Quantity: {\
                self.quantity}, Description: {self.description}, Price: {\
                    self.price}, Rating : {self.rating}, Seller Address: {self.seller_address}"
